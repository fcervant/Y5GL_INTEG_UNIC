sap.ui.define(["./BaseController", "../model/formatter", "sap/m/Dialog", "sap/m/Button", "sap/m/Text"], function(t, e, a, i, r) {
    "use strict";
    return t.extend("votorantim.Y5GL_INTEGRACAO_UNICO.controller.Worklist", {
        formatter: e,
        onInit: function() {
			...
			if (defAmb !== -1) {
				// Dados de PRD
                this.ApiKey = "jgzoWwO7BJSX14qDThyvOFTRUuDDnfey";
                this.LinkCpi = "https://votorantim.apimanagement.br10.hana.ondemand.com:443/ve-cpi-prd/http/ve/acessorh/"
            } else {
				// Dados de DEV
				this.ApiKey = "3GO6TQ7AsqiDIeJWZwgA1qCbii4ebqVK";
				this.LinkCpi = "https://api-dev.apimanagement.br10.hana.ondemand.com/ve-cpi-dev/http/ve/acessorh/";
			}
        ...
        defineIcon: function() {
            var t = jQuery.sap.getModulePath("votorantim.Y5GL_INTEGRACAO_UNICO");
            var e = t + "/imagens/VE.jpg";
            return e
        },
                    ...
                    press: function() {
                        t.create(d, C, {
                            success: function(t, e) {
                                sap.m.MessageBox.success("Enviando para processamento", {
                                    actions: ["OK"],
                                    onClose: function(e) {
