sap.ui.define([
	"sap/ui/test/Opa5",
	"votorantim/Y5GL_INTEGRACAO_UNICO/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("votorantim.Y5GL_INTEGRACAO_UNICO.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZET_CBMM_CF_APROVADORSet/" + sObjectId;
