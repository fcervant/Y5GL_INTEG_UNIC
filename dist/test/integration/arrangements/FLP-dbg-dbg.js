...
sap.ui.define([
	...
	"votorantim/Y5GL_INTEGRACAO_UNICO/test/flpSandbox"
	...
	return Opa5.extend("votorantim.Y5GL_INTEGRACAO_UNICO.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZET_CBMM_CF_APROVADORSet/" + encodeURIComponent(sObjectId);
